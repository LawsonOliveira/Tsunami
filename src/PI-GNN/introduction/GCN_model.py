...
import element_mesh
import utils
from graph_handling import build_toy_graph
import init_parameters_handling as iph
...
solver = PIGNN(update_node_fn, graph, true_solution=true_solution)
solver.train(graph,50, 100)

print(type(solver.laplacian(solver.params,graph)))

utils.plot_comparison_to_ground_truth(solver,graph)
