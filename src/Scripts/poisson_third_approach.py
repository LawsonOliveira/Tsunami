...
config['checkpoint_path'] = '../Checkpoints/Third_approach/Poisson/'
...
config['img_path'] = '../Images/Third_approach/Poisson/'
...
bound_values = [lambda p: jax.numpy.zeros(1) for i in range(bound.shape[0])]
...
solver = pinns.PINN_Poisson_third_approach(NN_eval, config['optimizer'], distance_class, config['reg'])
